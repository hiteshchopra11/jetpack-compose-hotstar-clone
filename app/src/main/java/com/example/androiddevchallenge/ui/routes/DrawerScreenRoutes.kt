package com.example.androiddevchallenge.ui.routes
...
val screens = listOf(
  DrawerScreensRoutes.Downloads,
  DrawerScreensRoutes.Watchlist,
  DrawerScreensRoutes.Prizes,
  DrawerScreensRoutes.Movies,
  DrawerScreensRoutes.Premium,
  DrawerScreensRoutes.Trending,
  DrawerScreensRoutes.Channels,
  DrawerScreensRoutes.Languages,
  DrawerScreensRoutes.Genres,
)
